            ...
            <div className="container mx-auto px-6 md:px-12 lg:px-16">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                    ...
                    <div>
                        ...
                        <ul className="space-y-1">
                            <li><a href="#" className="hover:text-blue-800">What We Offer</a></li>
                            <li><a href="#" className="hover:text-blue-800">Solutions</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-1">
                            ...
                            <li><a href="#" className="hover:text-blue-800">Terms of Service</a></li>
                        </ul>
                    </div>
                </div>
